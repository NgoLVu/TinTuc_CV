...
class User_newsController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('news.index')->with('msg','Them thanh cong');
    }
    /**
    ...
    public function edit(Request $request,$id=0)
    {
        ...
        return redirect()->route('news.index')->with('msg','tin tức không tồn tại');
        }
        }else
        {
        return redirect()->route('news.index')->with('msg','Liên kết không tồn tại');
        }
        $groups=getGroupNews();
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('news.index')->with('msg','Cập nhập thành công');
    }
    ...
    public function destroy($id)
    {
        if(!empty($id)){
           ...
           return redirect()->route('news.index')->with('msg',$msg);
    }
    ...
    public function update_your(Request $request)
    {
        ...
        $this->news->updateNews($Update,$id);
        return redirect()->route('news.yourList')->with('msg','Cập nhập thành công');
    }
}
